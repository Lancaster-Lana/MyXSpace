...
export class NotificationsViewerComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('statusHeaderTemplate', { read: ElementRef, static: false })
  statusHeaderTemplate: TemplateRef<any>;

  @ViewChild('statusTemplate', { read: ElementRef, static: false })
  statusTemplate: TemplateRef<any>;

  @ViewChild('dateTemplate', { read: ElementRef, static: false })
  dateTemplate: TemplateRef<any>;

  @ViewChild('contentHeaderTemplate', { read: ElementRef, static: false })
  contentHeaderTemplate: TemplateRef<any>;

  @ViewChild('contenBodytTemplate', { read: ElementRef, static: false })
  contenBodytTemplate: TemplateRef<any>;

  @ViewChild('actionsTemplate', { read: ElementRef, static: false })
