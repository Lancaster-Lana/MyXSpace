...
export class UsersManagementComponent implements OnInit, AfterViewInit
{
  ...
  @ViewChild('indexTemplate', { read: TemplateRef, static: true })
    indexTemplate: TemplateRef<any>;

  @ViewChild('userNameTemplate', { read: TemplateRef, static: true })
    userNameTemplate: TemplateRef<any>;

  @ViewChild('rolesTemplate', { read: TemplateRef, static: true })
