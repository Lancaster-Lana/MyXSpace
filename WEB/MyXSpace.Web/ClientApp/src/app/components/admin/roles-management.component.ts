  ...
  constructor(
    ...
    ngOnInit() {
        ...
        this.columns = [
          ...
          { prop: 'name', name: gT('roles.management.Name'), width: 150 },
          { prop: 'description', name: gT('roles.management.Description'), width: 300 },
      ...
      //if (this.canManageRoles) this.columns.push({ name: '', width: 130, cellTemplate: this.actionsTemplate, resizeable: false, canAutoResize: false, sortable: false, draggable: false });
        this.loadData();
    }
    ...
    get canManageRoles() {
      var hasRolesMngPerm = this.accountService.userHasPermission(Permission.manageRolesPermission);
      return hasRolesMngPerm;
    }
}
