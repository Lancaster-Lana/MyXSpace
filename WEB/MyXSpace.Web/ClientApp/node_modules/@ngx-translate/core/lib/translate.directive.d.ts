...
export declare class TranslateDirective implements AfterViewChecked, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<TranslateDirective, "[translate],[ngx-translate]", never, { 'translate': "translate", 'translateParams': "translateParams" }, {}, never>;
}
