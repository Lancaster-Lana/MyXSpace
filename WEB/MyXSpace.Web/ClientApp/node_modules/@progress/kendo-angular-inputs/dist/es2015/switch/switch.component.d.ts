...
export declare class SwitchComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    private changeValue;
    private focused;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<SwitchComponent, "kendo-switch", ["kendoSwitch"], { 'focusableId': "focusableId", 'checked': "checked", 'disabled': "disabled", 'readonly': "readonly", 'tabindex': "tabindex", 'tabIndex': "tabIndex", 'onLabel': "onLabel", 'offLabel': "offLabel" }, { 'onFocus': "focus", 'onBlur': "blur", 'valueChange': "valueChange" }, never>;
}
