...
export declare class ColorPaletteComponent implements OnInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<ColorPaletteComponent, "kendo-colorpalette", never, { 'format': "format", 'tileSize': "tileSize", 'value': "value", 'columns': "columns", 'palette': "palette", 'tabindex': "tabindex", 'disabled': "disabled", 'readonly': "readonly" }, { 'selectionChange': "selectionChange", 'valueChange': "valueChange", 'cellSelection': "cellSelection" }, never>;
}
