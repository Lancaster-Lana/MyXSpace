...
export declare class ColorPickerComponent implements OnDestroy, ControlValueAccessor {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<ColorPickerComponent, "kendo-colorpicker", never, { 'view': "view", 'readonly': "readonly", 'disabled': "disabled", 'format': "format", 'value': "value", 'popupSettings': "popupSettings", 'paletteSettings': "paletteSettings", 'gradientSettings': "gradientSettings", 'tabindex': "tabindex", 'icon': "icon", 'iconClass': "iconClass" }, { 'valueChange': "valueChange", 'open': "open", 'close': "close", 'onFocus': "focus", 'onBlur': "blur", 'activeColorClick': "activeColorClick" }, never>;
}
