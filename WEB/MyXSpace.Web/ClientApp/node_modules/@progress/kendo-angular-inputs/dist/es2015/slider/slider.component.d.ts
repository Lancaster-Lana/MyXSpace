...
export declare class SliderComponent implements AfterViewInit, ControlValueAccessor, OnChanges, OnDestroy {
    ...
    private getProps;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<SliderComponent, "kendo-slider", ["kendoSlider"], { 'focusableId': "focusableId", 'showButtons': "showButtons", 'tickPlacement': "tickPlacement", 'title': "title", 'vertical': "vertical", 'min': "min", 'max': "max", 'smallStep': "smallStep", 'largeStep': "largeStep", 'disabled': "disabled", 'readonly': "readonly", 'value': "value", 'tabindex': "tabindex", 'tabIndex': "tabIndex", 'incrementTitle': "incrementTitle", 'decrementTitle': "decrementTitle", 'dragHandleTitle': "dragHandleTitle", 'fixedTickWidth': "fixedTickWidth" }, { 'onFocus': "focus", 'onBlur': "blur", 'valueChange': "valueChange" }, ["labelTemplate"]>;
}
