import { Component, Directive, ElementRef, EventEmitter, Injectable, Input, NgModule, NgZone, Output, Renderer2, ViewChild } from '@angular/core';
...
const _c0 = ["expand"];
const _c1 = ["expandChild"];
const _c2 = ["shrink"];
const _c3 = [2, "position", "absolute", "display", "block", "left", "0", "top", "0", "right", "0", "bottom", "0", "z-index", "-1", "overflow", "hidden", "visibility", "hidden"];
const _c4 = ["expand", ""];
const _c5 = [2, "position", "absolute", "left", "0", "top", "0", "transition", "0s"];
const _c6 = ["expandChild", ""];
const _c7 = ["shrink", ""];
const _c8 = [2, "position", "absolute", "left", "0", "top", "0", "transition", "0s", "width", "200%", "height", "200%"];
...
ResizeSensorComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: ResizeSensorComponent, selectors: [["kendo-resize-sensor"]], factory: function ResizeSensorComponent_Factory(t) { return new (t || ResizeSensorComponent)(ɵngcc0.ɵɵdirectiveInject(ResizeBatchService), ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone), ɵngcc0.ɵɵdirectiveInject(Renderer2)); }, viewQuery: function ResizeSensorComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true);
        ɵngcc0.ɵɵviewQuery(_c1, true);
        ɵngcc0.ɵɵviewQuery(_c2, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.expand = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.expandChild = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.shrink = _t.first);
    } }, inputs: { rateLimit: "rateLimit" }, outputs: { resize: "resize" }, consts: 7, vars: 0, template: function ResizeSensorComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "div", _c3, _c4);
        ɵngcc0.ɵɵelement(2, "div", _c5, _c6);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(4, "div", _c3, _c7);
        ɵngcc0.ɵɵelement(6, "div", _c8);
        ɵngcc0.ɵɵelementEnd();
    } }, styles: ["[_nghost-%COMP%] { position: absolute; display: block; left: 0; top: 0; right: 0; bottom: 0; z-index: -1;overflow: hidden; visibility: hidden; }"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ResizeSensorComponent, [{
    ...
    }], function () { return [{ type: ResizeBatchService }, { type: ElementRef }, { type: NgZone }, { type: Renderer2 }]; }, { resizeBatchService: [], element: [], zone: [], renderer: [], rateLimit: [{
            type: Input
        }], resize: [{
            type: Output
        }], source: [], state: [], acceptedSize: [], ngAfterViewInit: [], ngAfterViewChecked: [], ngOnDestroy: [], acceptSize: [], lastWidth: [], lastHeight: [], scroll: [], init: [], subscription: [], parentElement: [], reset: [], measure: [], expand: [{
            type: ViewChild,
            args: ['expand']
        }], expandChild: [{
            type: ViewChild,
