...
export declare class ComboBoxComponent implements ControlValueAccessor, OnDestroy, OnChanges, FilterableDropDownComponentBase {
    ...
    private setMessages;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<ComboBoxComponent, "kendo-combobox", ["kendoComboBox"], { 'focusableId': "focusableId", 'allowCustom': "allowCustom", 'valueNormalizer': "valueNormalizer", 'placeholder': "placeholder", 'listHeight': "listHeight", 'suggest': "suggest", 'clearButton': "clearButton", 'disabled': "disabled", 'readonly': "readonly", 'tabindex': "tabindex", 'filterable': "filterable", 'data': "data", 'value': "value", 'popupSettings': "popupSettings", 'itemDisabled': "itemDisabled", 'tabIndex': "tabIndex", 'valuePrimitive': "valuePrimitive", 'textField': "textField", 'valueField': "valueField", 'iconClass': "iconClass", 'loading': "loading" }, { 'valueChange': "valueChange", 'selectionChange': "selectionChange", 'filterChange': "filterChange", 'open': "open", 'close': "close", 'onFocus': "focus", 'onBlur': "blur" }, ["template", "headerTemplate", "footerTemplate", "noDataTemplate", "groupTemplate", "fixedGroupTemplate"]>;
}
