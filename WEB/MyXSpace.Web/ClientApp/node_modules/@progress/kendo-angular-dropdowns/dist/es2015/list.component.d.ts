...
export declare class ListComponent {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<ListComponent, "kendo-list", never, { 'data': "data", 'selected': "selected", 'focused': "focused", 'multipleSelection': "multipleSelection", 'textField': "textField", 'valueField': "valueField", 'height': "height", 'template': "template", 'groupTemplate': "groupTemplate", 'fixedGroupTemplate': "fixedGroupTemplate", 'show': "show", 'id': "id", 'optionPrefix': "optionPrefix" }, { 'onClick': "onClick" }, never>;
}
